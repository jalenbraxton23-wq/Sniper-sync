...
export default {
  ...
  // runs on whichever cron schedule fired -- MLB runs 3x/day (bigger
  // object budget on that provider), WNBA runs 2x/day on its own separate,
  // less frequent schedule since The Odds API's free tier is a tighter
  // 500 requests/month rather than MLB's 2,500
